...
namespace HFDActiveIncidents.Domain.Models.Mapping
{
    public class ActiveIncidentMap : EntityTypeConfiguration<ActiveIncident>
    {
        public ActiveIncidentMap()
        {
            // Primary Key
            this.HasKey(t => t.Id);
            ...
            this.Property(t => t.ServiceSessionId).HasColumnName("ServiceSessionId");

            // Relationships
            this.HasOptional(t => t.IncidentType)
                .WithMany(t => t.ActiveIncidents)
